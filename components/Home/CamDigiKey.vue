    ...
    <v-card class="rounded-0 pa-5 backgroundTheme" dark>
        <v-container>
            <v-row>
                ...
                <v-col cols="12">
                    <div class="subtitleSize md-2">
                        {{ $t('homePage.camdigikey.subtitle') }}
                    </div>
                </v-col>
            </v-row>
            <v-row>
                <v-col cols="12" md="4" sm="6" xs="12" class="d-flex align-center mb-6">
                    <v-card color="#C5C5C4" dark class="mr-15" width="400" height="200"></v-card>
                </v-col>
                <v-col col="12" md="8" sm="6" xs="12">
                    <v-row>
                        <v-col cols="12">
                            <div class="subtitleSize mb-4 text-justify">
                        ...
                        <v-col cols="12" md="4" sm="12" xs="12">
                            <v-btn 
                                width="100%"
                                href="https://github.com/Techo-Startup-Center/CamDigiKey-Sample-Code-Android"
                                target="_blank"
                        ...
                        <v-col cols="12" md="4" sm="12" xs="12">
                            <v-btn 
                                href="https://github.com/Techo-Startup-Center/CamDigiKey-Sample-Code-IOS"
                                target="_blank"
                        ...
                        <v-col cols="12" md="4" sm="12" xs="12">
                            <v-btn 
                                href="https://github.com/Techo-Startup-Center/CamDigiKey-Integration"
                                target="_blank"
...
.foo-hover-true {
    ...
    color: rgb(59, 62, 123) !important;
}

.foo-hover-false {
    background: rgb(59, 62, 123) !important;
