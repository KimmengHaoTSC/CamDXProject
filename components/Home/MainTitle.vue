  ...
  <v-card class="rounded-0 pa-5 backgroundTheme">
    <v-container>
        <v-row data-aos="fade-up" data-aos-duration="800" class="d-flex align-center mb-6">
          ...
          <v-col cols="12" md="6" sm="12" xs="12">
            <v-img class="img-fluid" :contain="true" max-height="400px" :src="require('@/assets/maintitle.png')">
            </v-img>
          </v-col>
        </v-row>
        <v-col cols="12" md="12" sm="12" xs="12" class="pt-15" align="center">
          <v-btn icon @click="$vuetify.goTo('#overview')">
